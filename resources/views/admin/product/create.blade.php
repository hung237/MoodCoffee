        ...
        <div class="row">
          {{-- form create --}}
            <div class="col-lg-11 pt-3 mt-3">
                <form class="row " action="/admin/product/store" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="col-md-6">
                        <div class="col-md-12">
                            <label for="inputEmail4" class="form-label">Tên sản phẩm</label>
                            <input name="name" type="text" class="form-control" id="inputEmail4" placeholder="Nhập tên sản phẩm">
                        </div>
                        ...
                        <div class="col-md-12 d-flex mt-2">
                            ...
                            <div class="col-6">
                                <img src="/assets/images/no-image-product.png" alt="" id="imagePreview" width="100%" height="auto">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <textarea name="description" class="form-control" id="exampleFormControlTextarea1" rows="8" placeholder="Nhập mô tả sản phẩm"></textarea>
                        </div>
                        <div class="col-12 text-end">
                        <button type="submit" class="btn btn-primary m-auto">Thêm Mới</button>
                        </div>
                        @if($errors->any())
